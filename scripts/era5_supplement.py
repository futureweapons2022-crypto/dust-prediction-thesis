"""
ERA5 Supplementary Download — handles years 2020-2024.
Runs alongside era5_optimized.py (which handles 2015-2019).
"""
...
print(f"ERA5 Supplement (2020-2024)", flush=True)
print(f"={'='*49}", flush=True)
print(f"Total requests: {len(tasks)}", flush=True)
